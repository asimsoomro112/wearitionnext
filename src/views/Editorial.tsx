    ...
    <div ref={containerRef} className="w-full bg-background min-h-screen">
      ...
      <section className="py-24 md:py-40 px-6 text-center border-t border-foreground/10">
        ...
        <MagneticButton strength={0.2} as="div" className="inline-block">
          <Link href="/shop" className="inline-block bg-foreground text-background px-16 py-6 uppercase text-xs tracking-[0.3em] font-bold hover:bg-accent hover:text-white transition-all duration-300 shadow-xl" data-cursor="SHOP">
            Shop The Edit
          </Link>
        </MagneticButton>
      </section>
