                ...
                <div className="flex flex-wrap gap-4 mb-4">
                  {images.split(',').map(img => img.trim()).filter(Boolean).map((url, i) => (
                    <div key={i} className="relative w-28 h-32 group border border-black/10 rounded-lg overflow-visible bg-black/[0.02]">
                      <img src={getOptimizedImage(url)} alt="" className="w-full h-full object-contain rounded p-1" referrerPolicy="no-referrer" />
                    ...
                    <div className="flex flex-wrap gap-4">
                      {colorImages[color].map((url, i) => (
                        <div key={i} className="relative w-20 h-24 group border border-black/10 rounded-lg overflow-visible bg-white">
                          <img src={getOptimizedImage(url)} alt="" className="w-full h-full object-cover rounded p-1" referrerPolicy="no-referrer" />
                          <button
                            type="button"
                            onClick={() => {
                              setColorImages(prev => ({
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-xs uppercase tracking-widest font-bold text-foreground/60">{isUploading ? 'Uploading to Firebase...' : 'Upload to Firebase Storage'}</span>
                </label>
              </div>
