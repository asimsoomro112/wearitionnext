        ...
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <form onSubmit={handleTrack} className="space-y-6">
            ...
            <button 
              ...
              className="w-full bg-foreground text-background py-5 uppercase text-xs tracking-[0.3em] font-bold hover:bg-accent transition-all duration-300 disabled:opacity-50"
            >
